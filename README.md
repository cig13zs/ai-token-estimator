...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/ai-token-estimator/](https://cig13zs.github.io/ai-token-estimator/) or install the offline Chrome Extension package.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/ai-token-estimator.git
   ```
